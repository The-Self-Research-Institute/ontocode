...
public class DesktopDownloadService {
    ...
    private static final String[] KNOWN_PLATFORMS = {
        WINDOWS_PLATFORM, "linux-x64", "linux-deb", "linux-deb-arm64", "linux-arm64", "linux-flatpak", "mac-arm64",
    };
    ...
    static String normalizeClientOs(String value) {
        ...
        return switch (value.trim().toLowerCase()) {
            ...
            case "linux", "ubuntu", "debian", "linux-x64", "linux-deb", "linux-deb-arm64", "linux-arm64", "linux-flatpak" -> "linux";
