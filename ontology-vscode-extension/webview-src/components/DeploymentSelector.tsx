    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8 w-full max-w-4xl">
                        ...
                        <div className="flex flex-col items-center text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-300 mb-3">
                                    Connect to your local OntoCode instance
                                </p>
                    ...
                    >
                        <div className="flex flex-col items-center text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-300 mb-3">
                                    Connect to hosted OntoCode on AWS
                                </p>
                                <div className="text-xs text-gray-400 space-y-1">
                                    <div className="flex items-center justify-center gap-1">
                                        <Check size={14} className="text-green-400" />
                ...
                >
                    {isConfirming ? 'Connecting...' : selected ? `Continue with ${selected === 'self-hosted' ? 'Self-Hosted' : 'Cloud'}` : 'Select a deployment option'}
                </button>
