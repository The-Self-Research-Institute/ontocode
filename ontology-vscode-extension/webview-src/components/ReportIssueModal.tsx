...
export const ReportIssueModal: React.FC<ReportIssueModalProps> = ({
  ...
  const getIssueTypeStyle = (type: string) => {
    switch (type) {
      case "Bug":
        return { color: "bg-red-100 text-red-800 border-red-300", icon: Bug };
      case "Task":
        return { color: "bg-blue-100 text-blue-800 border-blue-300", icon: ListOrdered };
      default:
        return { color: "bg-purple-100 text-purple-800 border-purple-300", icon: Tag };
    }
  };
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className={`text-xs font-medium ${title.length > 180 ? "text-orange-600" : "text-gray-500"}`}>
                {title.length}/200
              </p>
            </div>
          </div>
              ...
              >
                ...
                >
                  <Upload
                    ...
                    className={`transition-colors ${isDragging ? "text-purple-700" : "text-purple-600"}`}
                  />
                </div>
                <span
                ...
                <span
                  className={`text-gray-500 transition-all ${attachments.length > 0 ? "text-xs mb-1" : "text-sm mb-3"}`}
                >
