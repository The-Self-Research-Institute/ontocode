...
interface UserGuideWebextensionProps {
  isOpen: boolean;
  onClose: () => void;
}

export const UserGuideWebextension: React.FC<UserGuideWebextensionProps> = ({ isOpen, onClose }) => {
              ...
              <div style={styles.sectionContent}>
                <div style={styles.subsection}>
                  ...
                  <ul style={styles.list}>
                    ...
                    <li>
                      <strong>Required Info:</strong> Provide the invitee email address and workspace role (Admin or Member)
                    </li>
                    <li>
                      <strong>Email Validation:</strong> Ensure email is valid and belongs to intended recipient
                    </li>
                    <li>
                      <strong>Role Selection:</strong> Start with Member for new workspace members and promote to Admin as needed
                    </li>
                    <li>
              ...
              <div style={styles.sectionContent}>
                <div style={styles.subsection}>
                  ...
                  <ul style={styles.list}>
                    ...
                    <li>
                      <strong>Role Assignment:</strong> Choose Viewer or Editor or Draft-Editor when adding a member. The project creator is Owner.
                    </li>
                    <li>
                  ...
                  <div style={styles.infoBox}>
                    ...
                    <ul style={styles.roleList}>
                      ...
                      <li>
                       <strong>Draft Editor:</strong> Can edit the ontology in draft mode, but the changes must be approved by an editor or the project owner.
                      </li>
                      <li>
                ...
                <div style={styles.subsection}>
                  ...
                  <ul style={styles.list}>
                    ...
                    <li>
                      <strong>Wrong Role:</strong> ❌ Giving Draft-editor, Viewer access to admin creates Confusion.
                    </li>
                    <li>
              ...
              <div style={styles.sectionContent}>
                <div style={styles.subsection}>
                  ...
                  <div style={{ marginBottom: "20px", paddingLeft: "12px", borderLeft: "3px solid #10b981" }}>
                    ...
                    <ul style={styles.list}>
                      ...
                      <li>
                        <strong>Supported Formats:</strong> Images (JPG, PNG, GIF, SVG, WebP), Videos (Mp4), documents (PDF, DOC,
                ...
                <div style={styles.subsection}>
                  ...
                  <ul style={styles.list}>
                    ...
                    <li>
                      <strong>Don't attach unsupported file types:</strong> Only images, videos, documents, text/log files, and
                ...
                <div style={styles.subsection}>
                  ...
                  <div style={{ marginBottom: "20px", paddingLeft: "12px", borderLeft: "3px solid #06b6d4" }}>
                    ...
                    <ul style={styles.list}>
                      ...
                      <li>
                        <strong>Seven Formats Available:</strong> Switch between <strong>Turtle</strong> (.ttl),{" "}
                        <strong>RDF/XML</strong> (.rdf), <strong>N-Triples</strong> (.nt), <strong>OWL/XML</strong>{" "}
                        (.owl), <strong>Manchester</strong> (.omn),  <strong>Functional</strong> (.ofn) and <strong>JSON-LD</strong> (.jsonld) using the
