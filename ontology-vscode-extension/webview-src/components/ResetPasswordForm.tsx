...
const ResetPasswordForm = ({ onBackToLogin, initialToken }: ResetPasswordFormProps) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-sm">Enter the reset token from your email and choose a new password.</p>
        </div>
        ...
        {successMessage ? (
          ...
          <>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="reset-token" className="block text-sm font-medium text-gray-200 mb-2">
                  Reset Token
                </label>
                <input
                  type="text"
                  ...
                  required
                  disabled={isLoading}
                  className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 text-white font-mono text-sm"
              ...
              <div>
                <label htmlFor="confirm-new-password" className="block text-sm font-medium text-gray-200 mb-2">
