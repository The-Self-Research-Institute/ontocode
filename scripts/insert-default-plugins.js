...
const DEFAULT_PLUGINS = [
  ...
  },
  {
    ...
    shortDescription: 'Interactive graph visualization for ontology classes and properties',
    description: 'Interactive graph visualization for ontology classes, properties, and relationships using network diagrams. Visualize your ontology structure with drag-and-drop interface, zoom controls, and layout algorithms.',
    latestVersion: '1.0.0',
