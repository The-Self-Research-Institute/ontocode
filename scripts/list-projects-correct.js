/**
 * Script to list all projects in the CORRECT database
 */
...
async function listProjects() {
    ...
    try {
        ...
        const projects = await collection.find({}).sort({ updatedAt: -1 }).limit(50).toArray();
        
        console.log(`📊 Total projects: ${await collection.countDocuments()}\n`);
