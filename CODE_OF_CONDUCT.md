...
We as members, contributors, and maintainers pledge to make participation in the OntoCode project a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
Instances of abusive, harassing, or otherwise unacceptable behavior must be reported privately — never in a public Issue, PR, or Discussion. Report to the project maintainers via a [private GitHub Security Advisory](https://github.com/The-Self-Research-Institute/ontocode/security/advisories/new) for this repository. All complaints will be reviewed and investigated promptly and fairly.
